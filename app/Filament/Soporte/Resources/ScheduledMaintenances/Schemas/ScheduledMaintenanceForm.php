        ...
        return $schema
            ->components([
                ...
                Section::make('Trazabilidad')
                    ->description('Timeline del ciclo + cadena de ciclos + snapshot del activo.')
                    ...
                    ->visible(fn (string $operation) => $operation === 'edit')
                    ->schema([
                        View::make('filament.soporte.components.maintenance-trazabilidad')
                            ->viewData(fn (?ScheduledMaintenance $record) => ['record' => $record])
                            ->columnSpanFull(),
                    ]),
