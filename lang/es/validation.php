...
/**
 * Mensajes de validación en español. Basado en las traducciones
 * oficiales de Laravel-Lang (https://laravel-lang.com).
 *
 * Si necesitas mensajes específicos para un campo, usa la clave
 * `attribute.rule` en `custom`. Los nombres de campo (ej. "Email"
 * en lugar de "email_address") van en `attributes`.
 */
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Mapeo de nombres "técnicos" de campo a etiquetas legibles. Filament
    | normalmente usa el `label()` del componente para esto, pero los
    | campos sin label específico caen aquí.
    */
